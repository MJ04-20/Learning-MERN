...
function drawSnake(){
    ...
    snake.forEach(snkaePart=>{
        ctx.fillRect(snkaePart.x,snkaePart.y,unitSize,unitSize);
        ctx.strokeRect(snkaePart.x,snkaePart.y,unitSize,unitSize);
        
    })   
}; 
function changeDirection(){
    const keyPressed=event.keyCode;
    // console.log(keyPressed); // to check key codes
    const LEFT=37;
    const UP=38;
    const RIGHT=39;
    const DOWN=40;
